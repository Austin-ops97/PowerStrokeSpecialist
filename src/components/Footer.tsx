  ...
  return (
    <footer className="bg-navy-deep">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-10">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-4">
              {/* Logo ~50% bigger than before: was h-9 w-9, now h-14 w-14 */}
              ...
              <span className="flex flex-col leading-none">
                ...
                <span className="mt-0.5 text-[9px] font-black tracking-[0.3em] text-navy-light">SPECIALIST</span>
              </span>
            </Link>
            <p className="mt-4 max-w-[240px] text-sm font-medium leading-relaxed text-white/40">
            ...
            <a
              ...
              className="mt-4 inline-flex items-center gap-2 text-sm font-semibold text-white/40 transition-colors hover:text-white"
            >
          ...
          <div>
            ...
            <a href={`tel:${BUSINESS_INFO.phone}`} className="btn-action mt-6 inline-flex text-[11px]">
      ...
      <div className="border-t border-white/[0.06]">
        <div className="wrap flex flex-col items-center justify-between gap-1 py-4 sm:flex-row">
